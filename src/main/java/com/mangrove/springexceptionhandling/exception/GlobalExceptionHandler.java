...
public class GlobalExceptionHandler extends DefaultErrorAttributes {
	...
	public final ResponseEntity<Map<String, Object>> handle(
		...
		List<ConstraintsViolationError> validationErrors = ex.getBindingResult()
																													 ...
																													 .stream()
																													 .map(error ->
																															new ConstraintsViolationError(error.getField(), error.getDefaultMessage())
																													 )
	...
	private ResponseEntity<Map<String, Object>> ofType(WebRequest request, HttpStatus status, String message, String key, List validationErrors) {
